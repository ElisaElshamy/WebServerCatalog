...
CLIENT_ID = json.loads(
    open('/var/www/FlaskApp/ItemCatalog/client_secrets.json', 'r').read())['web']['client_id']
APPLICATION_NAME = "Video Game Catalog"

#engine = create_engine('sqlite:///videogames.db')
engine = create_engine(
    'postgresql+psycopg2://catalog:catalog@localhost/videogames')
...
if __name__ == '__main__':
    ...
    app.debug = True
    app.run(host='34.205.92.238', port=5000)
